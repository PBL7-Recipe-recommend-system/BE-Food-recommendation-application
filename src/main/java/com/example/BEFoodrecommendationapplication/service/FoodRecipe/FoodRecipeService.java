...
public interface FoodRecipeService {
    ...
    Page<SearchResult> search(String name, String category, Integer rating, Integer timeRate, Integer minCalories, Integer maxCalories, Pageable pageable, Integer userId);
